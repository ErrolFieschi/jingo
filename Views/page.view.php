...
<button class="btn_style" id="mode_render" style="float: right" value="0">Rendu</button>
...
<div id="former">
    ...
    <div id="text_create" class="edit_page">
        <textarea id="textarea_form" name="textarea_form" rows="4" cols="40" class="page_form_input"></textarea>
        <br>
...
<div class="render row" id="btn_id">
    <div id="div_choice_1" class="col-4">
        <div class="border_render col-3"></div>
    </div>
...
<button class="btn_style" id="export_json" style="float: right" value="0">Export</button>
